...
function Carousel({
    ...
    //Iniciar el cambio automático de diapositiva
    useEffect(() => {
        if (automatic) {
            var index = slide;
    ...
    function scrollTo(el) {
        ...
        // comprobar si el elemento no está a la vista
                ...
                >
                    ...
                    >
                        {data.map((item, index) => {
                            return (
                                <div
                                    className="carousel-item fade drop-shadow-[0_35px_35px_rgba(0,0,0,0.25)]"
                                    style={{
                                        maxWidth: width ? width : "600px",
                                        maxHeight: height ? height : "400px",
                                    }}
