        ...
        <div className="mt-28 mb-10 flex-col justify-center align-center w-full text-center">
            ...
            <div className="text-left w-2/3 m-auto">
                <div className="plan-container">
                    ...
                    <img className="plan-img"src="media/images/planes-pajareando.jpg" alt="img-planes"/>
                </div>
                <div className="plan-container">
                    <div className="plan-sub-container">
                ...
                <div className="plan-container">
                    ...
                    <img className="plan-img"src="media/images/planes-senderismo.jpg" alt="img-planes"/> 
                </div>
            </div>
        </div>
    )
